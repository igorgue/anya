...
local function get_plugin_root()
	...
	-- Go up from lua/agent_nvim/ to plugin root
	return vim.fn.fnamemodify(plugin_lua_dir, ":h:h")
end

-- Load logo from file
local function load_logo()
	local logo_path = get_plugin_root() .. "/res/logo.txt"
	local lines = {}
...
-- Logo lines (ASCII art) - loaded from file
M.logo_lines = load_logo()

-- Full welcome message structure
M.welcome_message = (function()
	local msg = { "```" }
	...
	table.insert(msg, "```")
	table.insert(msg, "")
	table.insert(msg, "> Type your request in the prompt below.")
	return msg
end)()
