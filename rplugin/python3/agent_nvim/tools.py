...
def gh(command: str, cwd: str = None, timeout: int = 30) -> str:
    ...
    try:
        ...
        try:
            ...
            process.kill()
            return f"Error: GitHub CLI command timed out after {timeout} seconds"
        ...
        return f"Error executing GitHub CLI command: {e}"
